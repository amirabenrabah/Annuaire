...
//il faut ajouter cette methode parsque c'est necessaire avoir une relation d'ordre keys entre les personnes 
@Override
public int compareTo(Object arg) {
	
	
	if (! (arg instanceof Personne) )
        throw new ClassCastException("On peut pas comparer un " + 
        		arg.getClass().getName() + " avec une Personne");
